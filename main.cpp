...
{
    string defFileName, lefFileName, outFileName;
    ...
    cout << "block name : " << block->getName() << " " << block->getConstName() << " " << block->getDefUnits() << endl;
    //def.createChip(libs, defFileName.c_str());
    readLef(db);
    readDef(db);
