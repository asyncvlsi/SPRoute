    ...
    for(netID=0; netID<numValidNets; netID++)
    {
        ...
        /*{
            ...
            if(string(nets[netID]->name) == "iopin242") {
                cout << "numpins: " << nets[netID]->numPins << " deg: " << nets[netID]->deg << endl;
                for(d=0;d<2*deg-2;d++)
                {
                    if(d<deg)
                    {
                        cout << "after flutenormal: " << nets[netID]->pinX[d] << " " << nets[netID]->pinY[d] << " " << nets[netID]->pinL[d] << endl;
                    }
                }
                cout << " ================ " << endl;
            }
